...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Reliable handyman services in Oak Ridge, TN. Repairs, plumbing, electrical, and more. Call us at (865) 247-1871.",
...
const data: ServiceAreaData = {
  ...
  subheadline:
    "Serving Oak Ridge homeowners with reliable repairs, maintenance, and home improvements. We get the job done right without the runaround.",
  intro:
