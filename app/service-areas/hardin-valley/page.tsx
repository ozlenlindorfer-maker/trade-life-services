...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Reliable handyman services in Hardin Valley and northwest Knoxville. Call us at (865) 247-1871.",
...
const data: ServiceAreaData = {
  ...
  subheadline:
    "Hardin Valley's go-to handyman for repairs, maintenance, and home improvements. We serve the entire northwest Knoxville corridor — fast response, fair pricing.",
  intro:
