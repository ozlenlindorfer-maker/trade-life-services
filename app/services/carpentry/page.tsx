      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-dim text-xl max-w-xl leading-relaxed mb-10">
            Shelving, doors, trim, decks — built right and built to last. David&rsquo;s carpentry work across Knoxville is done with care, not cut corners.
          </p>
      ...
      <section className="py-24" style={{ background: "#141210" }}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="mb-14">
            ...
            <h2 className="font-heading text-5xl sm:text-6xl text-cream mt-2 mb-4">Carpentry Jobs David Takes On</h2>
            <p className="text-dim text-lg max-w-xl leading-relaxed">From small trim fixes to full deck builds, David handles the carpentry work that makes your Knoxville home look and function better.</p>
          </div>
